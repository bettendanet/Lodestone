...
//modImplementation("io.github.ladysnake:satin:${property("satin_version")}")
    ...
    compileOnly("maven.modrinth:sodium:mc${property("minecraft_version")}-${property("sodium_version")}-fabric")
    compileOnly("maven.modrinth:iris:${property("iris_version")}+${property("minecraft_version")}-fabric")
